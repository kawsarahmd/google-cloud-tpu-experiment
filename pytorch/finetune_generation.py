#!/usr/bin/env python
"""
Universal Text Generation Fine-tuning Script
Supports: GPT-2, GPT-Neo, GPT-J, LLaMA, OPT, BLOOM

Fine-tune generative models on domain-specific text.
...
@dataclass
class Arguments:
    """All arguments for generation fine-tuning."""
    ...
    dataset_name: str = field(
        metadata={"help": "HuggingFace dataset name or path to local dataset"}
    )
    ...
    gradient_accumulation_steps: int = field(
        default=4, metadata={"help": "Gradient accumulation"}
    )
...
def main():
    ...
    eval_dataloader = DataLoader(
        tokenized_datasets.get("validation", tokenized_datasets.get("test", tokenized_datasets["train"])),
